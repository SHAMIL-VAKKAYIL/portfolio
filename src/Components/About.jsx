    ...
    <div id='ABOUT' className="bg-[#191919] flex justify-center ">
      <div className=" w-[80%] md:p-4 grid grid-cols-1 sm:flex sm:justify-center m-5  gap-5 p-10  ">
        ...
        <div className="  justify-center w-[80%] ">
          ...
          <p className='text-white sm:mt-10'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure itaque aperiam nostrum harum id possimus autem consectetur, natus deserunt temporibus tempore deleniti inventore eaque rerum at adipisci fugit debi</p>
        </div>
