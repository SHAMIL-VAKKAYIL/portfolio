        ...
        <div className=" mx-auto sm:w-[85%] lg:w-[70%] flex flex-col justify-center items-center gap-y-2">
            <div className="w-full flex flex-col gap-3 ">
                <div className="flex justify-end items-center ">
                    <div className="flex">
                        <div className="p-2 rounded-[10px] border-secondary border-[2px] flex items-center justify-center">
                            <div className="">
                                <BsGithub size={26} color="#F0F0F0" />
                            </div>
                        </div>
                        <div className="border-secondary border-[2px] p-2 rounded-[10px] flex items-center justify-center ">
                            <div >
                                <BsLinkedin size={26} color="#F0F0F0" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-x-2 bg-transparent w-full  overflow-hidden ">
                ...
                {/* frontend */}
                <div className="bg-card border-2 border-secondary rounded-lg  flex flex-col p-3 gap-  ">
